...
void AddStudentPage::service()
{
	...
	case 3:
		...
		break;
	case 4:
		cout << "Podaj wydzial: (budownictwa | chemiczny | informatyki | matematyki | mechaniczny | zarzadzania)" << endl;
		cin >> this->strings[2];
		
		while (!cin.good() || (this->strings[2] != "budownictwa" && this->strings[2] != "chemiczny" && this->strings[2] != "informatyki" && this->strings[2] != "matematyki" && this->strings[2] != "mechaniczny" && this->strings[2] != "zarzadzania"))
		{
	...
	case 5:
		...
		{
			cout << "Podaj kierunek: (architektura | biogospodarka)" << endl;
			cin >> this->strings[3];

			while (!cin.good() || (this->strings[3] != "architektura" && this->strings[3] != "biogospodarka"))
			{
		...
		{
			cout << "Podaj kierunek: (biotechnologia)" << endl;
			cin >> this->strings[3];

			while (!cin.good() || (this->strings[3] != "biotechnologia"))
			{
				this->strings[3].clear();
				this->getWindow()->refresh();
				cout << "Podaj kierunek: (biotechnologia)" << endl;
		...
		{
			cout << "Podaj kierunek: (elektrotechnika | informatyka)" << endl;
			cin >> this->strings[3];

			while (!cin.good() || (this->strings[3] != "elektrotechnika" && this->strings[3] != "informatyka"))
			{
				this->strings[3].clear();
				this->getWindow()->refresh();
				cout << "Podaj kierunek: (elektrotechnika | informatyka)" << endl;
		...
		{
			cout << "Podaj kierunek: (matematyka | fizyka)" << endl;
			cin >> this->strings[3];

			while (!cin.good() || (this->strings[3] != "matematyka" && this->strings[3] != "fizyka"))
			{
				this->strings[3].clear();
				this->getWindow()->refresh();
				cout << "Podaj kierunek: (matematyka | fizyka)" << endl;
		...
		{
			cout << "Podaj kierunek: (logistyka | zarzadzanie)" << endl;
			cin >> this->strings[3];

			while (!cin.good() || (this->strings[3] != "logistyka" && this->strings[3] != "zarzadzanie"))
			{
				this->strings[3].clear();
				this->getWindow()->refresh();
				cout << "Podaj kierunek: (logistyka | zarzadzanie)" << endl;
	...
	case 8:
		cout << "Podaj typ: (stacjonarne lub zaoczne)" << endl;
		cin >> this->strings[4];

		// dopoki wprowadzone dane sa niepoprawne kontynuje prosbe o podanie odpowiedniego trybu studiow
		while (!cin.good() || (this->strings[4] != "stacjonarne" && this->strings[4] != "zaoczne"))
		{
	...
	default:
		...
		if (index == -1)
			this->onFailure("Podany student juz istnieje");
		else
			this->onSuccess("Dodano nowego studenta o indeksie");
